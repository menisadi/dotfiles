...
-- 1) App jumpers
hk.bind({ "alt", "shift" }, "return", function()
	app.launchOrFocusByBundleID("net.kovidgoyal.kitty")
end)
hk.bind({ "alt", "shift" }, "w", function()
	app.launchOrFocusByBundleID("com.apple.Safari")
end)
hk.bind({ "alt", "shift" }, "s", function()
	app.launchOrFocusByBundleID("com.tinyspeck.slackmacgap")
end)
hk.bind({ "alt", "shift" }, "b", function()
	app.launchOrFocusByBundleID("org.mozilla.firefox")
end)
hk.bind({ "alt", "shift" }, "p", function()
	app.launchOrFocusByBundleID("com.spotify.client")
end)

hk.bind({ "alt", "shift" }, "1", function()
	app.launchOrFocusByBundleID("com.apple.Safari")
end)
hk.bind({ "alt", "shift" }, "2", function()
	app.launchOrFocusByBundleID("net.kovidgoyal.kitty")
end)
hk.bind({ "alt", "shift" }, "3", function()
	app.launchOrFocusByBundleID("com.tinyspeck.slackmacgap")
end)
hk.bind({ "alt", "shift" }, "0", function()
	app.launchOrFocusByBundleID("org.mozilla.firefox")
end)
hk.bind({ "alt", "shift" }, "9", function()
	app.launchOrFocusByBundleID("com.todoist.mac.Todoist")
end)
hk.bind({ "alt", "shift" }, "8", function()
	app.launchOrFocusByBundleID("com.spotify.client")
end)
