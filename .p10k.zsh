# Generated by Powerlevel10k configuration wizard on 2023-12-24 at 21:31 IST.
...
# 24h time, 2 lines, disconnected, left frame, white-ornaments, sparse, few icons,
...
() {
  ...
  # Show only the first word (everything up to the first space)
  typeset -g POWERLEVEL9K_TIMEWARRIOR_CONTENT_EXPANSION='${P9K_CONTENT%% *}'
